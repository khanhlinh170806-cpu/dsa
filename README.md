...
|-----------|--------------|---------|
| [Họ và Tên của bạn] | [Mã số sinh viên] | Trưởng nhóm - Phát triển Core |
| [Tên thành viên 2] | [Mã số sinh viên] | Phát triển Algorithm & LeetCode |
| [Tên thành viên 3] | [Mã số sinh viên] | Kiểm thử & Viết tài liệu |
